...
@endsection
@section('title', 'ECIX - Perfil Usuario')

@section('content_header')
    <h1>Perfil Usuario
    <small>{{auth()->user()->present()->fullName()}}</small>
    </h1>
@stop
        ...
        <div class="col-md-3">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle" src="{{auth()->user()->present()->getPicUser()}}" alt="User profile picture">

                    <h3 class="profile-username text-center">{{auth()->user()->present()->fullName()}}</h3>
