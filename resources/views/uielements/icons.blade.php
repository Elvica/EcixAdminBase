...
@endsection
@section('title', 'ECIX - Iconss')

@section('content_header')
    <h1>Iconos
    <small>Previsualización Iconos</small>
    </h1>
@stop
        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item active"><a href="#fa-icons" role="tab" data-toggle="tab">Font Awesome</a></li>
                    <li class="nav-item "><a href="#glyphicons" role="tab" data-toggle="tab">Glyphicons</a></li>
                </ul>
